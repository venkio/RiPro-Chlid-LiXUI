  ...
  <div class="content-box">
   ...
   <?php	if ($cao_price==0) {
    ...
    <?php endif; ?>
        ...
        <?php /*经典下载样式设置开始*/$site_oldfgxzys_lixui = _cao('site_oldfgxzys_lixui'); ?>
        <ul class="serv">
          <span>
            <li><i class="dashicons dashicons-shield"></i> <?php echo $site_oldfgxzys_lixui['is_oldfgxzys_text1'];?></li>
            <li><i class="dashicons dashicons-update-alt"></i> <?php echo $site_oldfgxzys_lixui['is_oldfgxzys_text2'];?></li>
          </span>
          <span>
            <li><i class="dashicons dashicons-plugins-checked"></i> <?php echo $site_oldfgxzys_lixui['is_oldfgxzys_text3'];?></li>
            <li><i class="dashicons dashicons-cloud"></i> <?php echo $site_oldfgxzys_lixui['is_oldfgxzys_text4'];?></li>
          </span>
          <span>
            <li><a href="<?php echo $site_oldfgxzys_lixui['is_oldfgxzys_link'];?>" target="_blank" class="howto">如何获得<?php echo ' '.$site_money_ua.' '; ?>？</a></li>
          </span>
        </ul>
        <span class="shengming">
          <p><i class="<?php echo $site_oldfgxzys_lixui['is_oldfgxzys_smicon'];?>"></i> <?php echo $site_oldfgxzys_lixui['is_oldfgxzys_smtext'];?></p>
        </span>
  ...
  <?php if (!_get_post_shop_status() || _get_post_shop_hide()) { ?>
    ...
    <?php /*内页正文栏仿MAC风彩色圆点角标开始-利熙网*/ if (_cao('is_nryzwlcsyd_lixui')) : ?>
        <div class="lixui-title-bar">
            <i class="lixui-title-iconse-down lixui-float-rightse"></i>
        </div>
